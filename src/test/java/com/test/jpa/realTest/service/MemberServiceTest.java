...
class MemberServiceTest {
    ...
    public void 맴버_서비스저장() throws Exception{
        MemberDto memberDto1 = new MemberDto("member1","pih6585@nate.com" ,"1234","서울","천호","111-11");
        Long memberId1 = memberService.memberCreate(memberDto1);

        MemberDto memberDto2 = new MemberDto("member2","pih1111@nate.com" ,"1234","강남","청담","121-11");
    ...
    public void 맴버_서비스전채조회() {
        ...
        assertThat(memberList).extracting("name").containsExactly("member1","member2");
    }

    @Test
    public void 맴버_서비스_페이징조회() {
        for(int i=0;i<100;i++){
            MemberDto memberDto = new MemberDto("member"+(i+1),"pih"+i+"@nate.com" ,"1234","서울","천호",i+1+"");
